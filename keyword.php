...
?>
    ...
    <div class="wrapper">
       <a href="barchart.php?positive=<?php echo $positive;?>&negative=<?php echo $negative; ?>&neutral=<?php echo $neutral; ?>&nofeedback=<?php echo $nofeedback; ?>"><button class="btn btn-primary p-2" align="center">Click here for Bar chart</button></a>&nbsp;&nbsp;<a href="piechart.php?positive=<?php echo $positive;?>&negative=<?php echo $negative; ?>&neutral=<?php echo $neutral; ?>&nofeedback=<?php echo $nofeedback; ?>"><button class="btn btn-primary p-2" align="center">Click here for Pie chart</button></a>
    </div> 
