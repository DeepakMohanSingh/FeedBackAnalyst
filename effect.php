...
if(isset($_POST["submit"]))
{
    ...
    if(move_uploaded_file($_FILES["file"]["tmp_name"], $filepath))
	{
	  ...
	  $line = fgetcsv($file);
	  $result=""; $happy=0; $sad=0; $excited=0; $angry=0; $nofeedback=0;
    ...
    fclose($file);
	//echo "POSITIVE: $positive<br>NEUTRAL: $neutral<br>NEGATIVE: $negative";
	}
	else
	{
...
<html lang="en">
  ...
  <body>
	...
	<br>
	<p align="center"><a href="uploadfile.php" class="btn btn-primary px-4 py-3">Upload file</a></p>
