...
if(isset($_POST["submit"]))
{
	...
	$req.="]";
    fclose($file);
    $response = emotion_batch($req);
	$result = json_decode($response);
	//echo $result->emotion;
	$iterator=$result->emotion;
	  foreach($iterator as $emotion)
	  {
		if(isset($emotion->Happy) && isset($emotion->Sad) && isset($emotion->Excited) && isset($emotion->Angry)){
	     $ar = array("HAPPY"=>$emotion->Happy, "SAD"=>$emotion->Sad, "EXCITED"=>$emotion->Excited, "ANGRY"=>$emotion->Angry);
	     $keyOfhighestVal = array_keys($ar,max($ar));
	     $res = $keyOfhighestVal[0];
	     if(strcmp($res,"HAPPY")==0)
		   $happy++;
	     else if(strcmp($res,"SAD")==0)
		   $sad++;
	     else if(strcmp($res,"EXCITED")==0)
		   $excited++;
	     else if(strcmp($res,"ANGRY")==0)
		   $angry++;
	  }
	  }
...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
       <a href="barchart.php?happy=<?php echo $happy;?>&excited=<?php echo $excited; ?>&sad=<?php echo $sad; ?>&angry=<?php echo $angry; ?>&nofeedback=<?php echo $nofeedback; ?>"><button class="btn btn-primary p-2" align="center">Click here for Bar chart</button></a>&nbsp;&nbsp;<a href="piechart.php?happy=<?php echo $happy;?>&excited=<?php echo $excited; ?>&sad=<?php echo $sad; ?>&angry=<?php echo $angry; ?>&nofeedback=<?php echo $nofeedback; ?>"><button class="btn btn-primary p-2" align="center">Click here for Pie chart</button></a>
    </div> 
