...
if(isset($_POST["submit"]))
{
     ...
     if(move_uploaded_file($_FILES["file"]["tmp_name"], $filepath))
	{
	  ...
	  $line = fgetcsv($file);
	  $result=""; $abusive=0; $hate_speech=0; $neither=0; $nofeedback=0; $color=0;
	  $request="[";
	...
	$req.="]";
    fclose($file);
    $response = abuse_batch($req);
	$result = json_decode($response);
	$iterator=$result->abuse;
	  foreach($iterator as $abuse)
	  {
	  if(isset($abuse->abusive) && isset($abuse->hate_speech) && isset($abuse->neither)){
	  $ar = array("ABUSIVE"=>$abuse->abusive, "HATE_SPEECH"=>$abuse->hate_speech, "NEITHER"=>$abuse->neither);
	  $keyOfhighestVal = array_keys($ar,max($ar));
	  $res = $keyOfhighestVal[0];
	  if(strcmp($res,"ABUSIVE")==0)
		$abusive++;
	  else if(strcmp($res,"HATE_SPEECH")==0)
		$hate_speech++;
	  else
		$neither++;
	  }
	  }
      if($neither>$abusive&&$neither>$hate_speech)
		$color=1;
	}
	else
	{
...
<html lang="en">
  ...
  <body>
	...
	<br>
	<p align="center"><a href="uploadfile.php?id=3" class="btn btn-primary px-4 py-3">Upload file</a></p>
    			...
    			<div class="col-md-10">
		          ...
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="<?php echo $abusive; ?>">0</strong>
		                <span>Abusive</span>
		              </div>
		            </div>
		          </div>
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="<?php echo $hate_speech; ?>">0</strong>
				  ...
				  ?>
		            <div class="block-18 text-center">
		              <div class="text">
		                <strong class="number" data-number="<?php echo $neither; ?>">0</strong>
		                <span>Neither</span>
		              </div>
		            </div>
		          </div>
    ...
    <div class="wrapper">
       <a href="barchart.php?abusive=<?php echo $abusive;?>&hatespeech=<?php echo $hate_speech; ?>&neither=<?php echo $neither; ?>&nofeedback=<?php echo $nofeedback; ?>"><button class="btn btn-primary p-2" align="center">Click here for Bar chart</button></a>&nbsp;&nbsp;<a href="piechart.php?abusive=<?php echo $abusive;?>&hatespeech=<?php echo $hate_speech; ?>&neither=<?php echo $neither; ?>&nofeedback=<?php echo $nofeedback; ?>"><button class="btn btn-primary p-2" align="center">Click here for Pie chart</button></a>
    </div> 
