...
<html lang="en">
  ...
  <h2 align="center"><b>Sentiment Analysis - Bar Chart Result<b></h2>
  <p align="center"><script>document.write(new Date());</script></p>
  <?php } 
  else if(isset($_GET["happy"])){ ?>
  <h2 align="center"><b>Emotion Analysis - Bar Chart Result<b></h2>
  <p align="center"><script>document.write(new Date());</script></p>
  <?php } 
  else if(isset($_GET["abusive"])){ ?>
  <h2 align="center"><b>Abusive content Analysis - Bar Chart Result<b></h2>
  <p align="center"><script>document.write(new Date());</script></p>
  <?php }
  else{ ?>
  <h2 align="center"><b>Taxonomy Analysis - Bar Chart Result<b></h2>
  <p align="center"><script>document.write(new Date());</script></p>  
  <?php } ?>
...
<h2 class="mb-4">Try our services</h2>
  ...
  <script>
	...
	theme: "light2",
	axisY: {
		title: "Count of reviewers"
	},
	data: [{
		type: "column",
		yValueFormatString: "#,##0.## reviewers",
